...
class InvoiceGenerator
{
    ...
    public function generate(Estimate $estimate)
    {
        ...
        $invoice->setPostalCode($estimate->getPostalCode());
        $invoice->setLocation($estimate->getLocation());
        $invoice->setProvince($estimate->getProvince());
        $invoice->setMandato($estimate->getMandato());
        $invoice->setFechaMandato($estimate->getFechaMandato());
        $invoice->setBic($estimate->getBic());
        $invoice->setIban($estimate->getIban());
