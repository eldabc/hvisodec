...
class GlobalSettingsType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('company_cp', TextType::class, [
                'required' => false,
                'label' => 'form.company_cp',
                'translation_domain' => 'SiwappConfigBundle',
            ])
            ->add('company_location', TextType::class, [
                'required' => false,
                'label' => 'form.company_location',
                'translation_domain' => 'SiwappConfigBundle',
            ])
            ->add('company_province', TextType::class, [
                'required' => false,
                'label' => 'form.company_province',
                'translation_domain' => 'SiwappConfigBundle',
            ])
            ...
            ->add('sepa_iban', TextType::class, [
                'required' => false,
                'label' => 'form.sepa_iban',
                'translation_domain' => 'SiwappConfigBundle',
            ])
            ->add('sepa_id_creditor', TextType::class, [
                'required' => false,
                'label' => 'form.sepa_id_creditor',
                'translation_domain' => 'SiwappConfigBundle',
            ])
            ->add('sepa_entity', TextType::class, [
                'required' => false,
                'label' => 'form.sepa_entity',
                'translation_domain' => 'SiwappConfigBundle',
            ])
            ->add('sepa_subsidiary', TextType::class, [
                'required' => false,
                'label' => 'form.sepa_subsidiary',
                'translation_domain' => 'SiwappConfigBundle',
            ])
